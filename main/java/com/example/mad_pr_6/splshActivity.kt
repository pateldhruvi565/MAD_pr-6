package com.example.mad_pr_6

import android.content.Intent import android.graphics.drawable.AnimationDrawable import android.os.Bundle import android.view.animation.Animation import android.view.animation.AnimationUtils import android.widget.ImageView import androidx.activity.enableEdgeToEdge import androidx.appcompat.app.AppCompatActivity
...
class SplashActivity : AppCompatActivity(), Animation.AnimationListener
{
    ...
    val uvpce_imageview =
        findViewById<ImageView>(R.id.uvpce_imageview)
    ...
    override fun onWindowFocusChanged(hasFocus: Boolean) { super.onWindowFocusChanged(hasFocus)
        if (hasFocus) { gunianimation.start()
